...
about.add_command(label='Created By Abhimanyu Sharma',command=lambda:webbrowser.open("https://github.com/0xN1nja"))
...
context_menu.add_command(label="Cut",image=cut_icon,compound=tk.LEFT,command=lambda:text_editor.event_generate("<Control-x>"))
context_menu.add_command(label="Copy",image=copy_icon,compound=tk.LEFT,command=lambda:text_editor.event_generate("<Control-c>"))
context_menu.add_command(label="Paste",image=paste_icon,compound=tk.LEFT,command=lambda:text_editor.event_generate("<Control-v>"))
context_menu.add_separator()
context_menu.add_command(label="Select All",image=select_all_icon,compound=tk.LEFT,command=lambda:text_editor.event_generate("<Control-a>"))
context_menu.add_command(label="Clear All",image=clear_all_icon,compound=tk.LEFT,command=lambda:text_editor.delete(1.0,tk.END))
context_menu.add_separator()
context_menu.add_command(label="Undo",image=undo_icon,compound=tk.LEFT,command=lambda:text_editor.event_generate("<Control-z>"))
context_menu.add_command(label="Redo",image=redo_icon,compound=tk.LEFT,command=lambda:text_editor.event_generate("<Control-y>"))
...
def save_file(event=None):
    ...
    try:
        if url:
            ...
            url=filedialog.asksaveasfilename(defaultextension='.txt',filetypes=(('Text Files','*.txt'),('All Files','*.*')))
...
file.add_command(label='New Window',image=new_window_icon,compound=tk.LEFT,accelerator='(Ctrl+Shift+N)',command=open_new_window)
file.add_separator()
...
edit.add_command(label="Get Time And Date",image=timeImage,compound=tk.LEFT,accelerator="(F5)",command=get_date_time)
#view commands
